...
(function(root) {
    ...
    var searchIndex = [
        ...
        {"type": "Namespace", "link": "Alorel.html", "name": "Alorel", "doc": "Namespace Alorel"}, {
            ...
            "type": "Namespace",
            "link": "Alorel/Dropbox/Operation/Sharing.html",
            "name": "Alorel\\Dropbox\\Operation\\Sharing",
            "doc": "Namespace Alorel\\Dropbox\\Operation\\Sharing"
        }, {
            "type": "Namespace",
            ...
            "type": "Namespace",
            "link": "Alorel/Dropbox/Parameters/Collections.html",
            "name": "Alorel\\Dropbox\\Parameters\\Collections",
            "doc": "Namespace Alorel\\Dropbox\\Parameters\\Collections"
        }, {
            "type": "Namespace",
        ...
        {
            "type": "Interface",
            "fromName": "Alorel\\Dropbox\\Exception",
            "fromLink": "Alorel/Dropbox/Exception.html",
            "link": "Alorel/Dropbox/Exception/DropboxException.html",
            "name": "Alorel\\Dropbox\\Exception\\DropboxException",
            "doc": "&quot;Exception wrapper&quot;"
        },
        ...
        {
            "type": "Class",
            "fromName": "Alorel\\Dropbox\\Operation\\Sharing",
            "fromLink": "Alorel/Dropbox/Operation/Sharing.html",
            "link": "Alorel/Dropbox/Operation/Sharing/AddFileMember.html",
            "name": "Alorel\\Dropbox\\Operation\\Sharing\\AddFileMember",
            "doc": "&quot;Adds specified members to a file.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Operation\\Sharing\\AddFileMember",
            "fromLink": "Alorel/Dropbox/Operation/Sharing/AddFileMember.html",
            "link": "Alorel/Dropbox/Operation/Sharing/AddFileMember.html#method_raw",
            "name": "Alorel\\Dropbox\\Operation\\Sharing\\AddFileMember::raw",
        ...
        {
            "type": "Class",
            "fromName": "Alorel\\Dropbox\\Options\\Builder",
            "fromLink": "Alorel/Dropbox/Options/Builder.html",
            "link": "Alorel/Dropbox/Options/Builder/AddFileMemberOptions.html",
            "name": "Alorel\\Dropbox\\Options\\Builder\\AddFileMemberOptions",
            "doc": "&quot;Options for the add&lt;em&gt;file&lt;\/em&gt;member operation&quot;"
        },
        ...
        {
            "type": "Trait",
            "fromName": "Alorel\\Dropbox\\Options\\Mixins",
            "fromLink": "Alorel/Dropbox/Options/Mixins.html",
            "link": "Alorel/Dropbox/Options/Mixins/AccessLevelTrait.html",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\AccessLevelTrait",
            "doc": "&quot;What access level the members will have&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Options\\Mixins\\AccessLevelTrait",
            "fromLink": "Alorel/Dropbox/Options/Mixins/AccessLevelTrait.html",
            "link": "Alorel/Dropbox/Options/Mixins/AccessLevelTrait.html#method_setAccessLevel",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\AccessLevelTrait::setAccessLevel",
            "doc": "&quot;What access level the members will have. Please use one of the constants in the\n{@link \\Alorel\\Dropbox\\Parameters\\AccessLevel AccessLevel} class to protect against format changes and human\nerror&quot;"
        },

        {
            ...
            "fromName": "Alorel\\Dropbox\\Options\\Mixins",
            "fromLink": "Alorel/Dropbox/Options/Mixins.html",
            "link": "Alorel/Dropbox/Options/Mixins/AddMessageAsCommentTrait.html",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\AddMessageAsCommentTrait",
            "doc": "&quot;If the custom message should be added as a comment on the file. The default for this field is False.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Options\\Mixins\\AddMessageAsCommentTrait",
            "fromLink": "Alorel/Dropbox/Options/Mixins/AddMessageAsCommentTrait.html",
            "link": "Alorel/Dropbox/Options/Mixins/AddMessageAsCommentTrait.html#method_setAddMessageAsComment",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\AddMessageAsCommentTrait::setAddMessageAsComment",
            "doc": "&quot;If the custom message should be added as a comment on the file. The default for this field is False.&quot;"
        },
...

        {
            ...
            "fromName": "Alorel\\Dropbox\\Options\\Mixins",
            "fromLink": "Alorel/Dropbox/Options/Mixins.html",
            "link": "Alorel/Dropbox/Options/Mixins/CustomMessageTrait.html",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\CustomMessageTrait",
            "doc": "&quot;Message to send to added members in their invitation&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Options\\Mixins\\CustomMessageTrait",
            "fromLink": "Alorel/Dropbox/Options/Mixins/CustomMessageTrait.html",
            "link": "Alorel/Dropbox/Options/Mixins/CustomMessageTrait.html#method_setCustomMessage",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\CustomMessageTrait::setCustomMessage",
            "doc": "&quot;Message to send to added members in their invitation&quot;"
        },
...

        {
            ...
            "fromName": "Alorel\\Dropbox\\Options\\Mixins",
            "fromLink": "Alorel/Dropbox/Options/Mixins.html",
            "link": "Alorel/Dropbox/Options/Mixins/QuietTrait.html",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\QuietTrait",
            "doc": "&quot;Whether added members should be notified via device notifications of their invitation. The default for this\nfield is False.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Options\\Mixins\\QuietTrait",
            "fromLink": "Alorel/Dropbox/Options/Mixins/QuietTrait.html",
            "link": "Alorel/Dropbox/Options/Mixins/QuietTrait.html#method_setQuiet",
            "name": "Alorel\\Dropbox\\Options\\Mixins\\QuietTrait::setQuiet",
            "doc": "&quot;Whether added members should be notified via device notifications of their invitation. The default for\nthis field is False.&quot;"
        },
        ...
        {
            "type": "Class",
            "fromName": "Alorel\\Dropbox\\Parameters",
            "fromLink": "Alorel/Dropbox/Parameters.html",
            "link": "Alorel/Dropbox/Parameters/ACLUpdatePolicy.html",
            "name": "Alorel\\Dropbox\\Parameters\\ACLUpdatePolicy",
            "doc": "&quot;Policy governing who can change a shared folder&#039;s access control list (ACL). In other words, who can add, remove, or change the privileges of members.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\ACLUpdatePolicy",
            "fromLink": "Alorel/Dropbox/Parameters/ACLUpdatePolicy.html",
            "link": "Alorel/Dropbox/Parameters/ACLUpdatePolicy.html#method_owner",
            "name": "Alorel\\Dropbox\\Parameters\\ACLUpdatePolicy::owner",
            "doc": "&quot;Only the owner can update the ACL.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\ACLUpdatePolicy",
            "fromLink": "Alorel/Dropbox/Parameters/ACLUpdatePolicy.html",
            "link": "Alorel/Dropbox/Parameters/ACLUpdatePolicy.html#method_editors",
            "name": "Alorel\\Dropbox\\Parameters\\ACLUpdatePolicy::editors",
            "doc": "&quot;Any editor can update the ACL. This may be further restricted to editors on the same team.&quot;"
        },
...

        {
            ...
            "fromName": "Alorel\\Dropbox\\Parameters",
            "fromLink": "Alorel/Dropbox/Parameters.html",
            "link": "Alorel/Dropbox/Parameters/AbstractTagParameter.html",
            "name": "Alorel\\Dropbox\\Parameters\\AbstractTagParameter",
            "doc": "&quot;An abstract parameter that just has a tag&quot;"
        },

        {
            ...
            "fromName": "Alorel\\Dropbox\\Parameters",
            "fromLink": "Alorel/Dropbox/Parameters.html",
            "link": "Alorel/Dropbox/Parameters/AccessLevel.html",
            "name": "Alorel\\Dropbox\\Parameters\\AccessLevel",
            "doc": "&quot;The access level to give. Default is \&quot;viewer\&quot;&quot;"
        },

        {
            "type": "Class",
            "fromName": "Alorel\\Dropbox\\Parameters\\Collections",
            "fromLink": "Alorel/Dropbox/Parameters/Collections.html",
            "link": "Alorel/Dropbox/Parameters/Collections/MemberSelectors.html",
            "name": "Alorel\\Dropbox\\Parameters\\Collections\\MemberSelectors",
            "doc": "&quot;Collection of {@link MemberSelector}s&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\Collections\\MemberSelectors",
            "fromLink": "Alorel/Dropbox/Parameters/Collections/MemberSelectors.html",
            "link": "Alorel/Dropbox/Parameters/Collections/MemberSelectors.html#method___construct",
            "name": "Alorel\\Dropbox\\Parameters\\Collections\\MemberSelectors::__construct",
            "doc": "&quot;MemberSelectors constructor.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\Collections\\MemberSelectors",
            "fromLink": "Alorel/Dropbox/Parameters/Collections/MemberSelectors.html",
            "link": "Alorel/Dropbox/Parameters/Collections/MemberSelectors.html#method_add",
            "name": "Alorel\\Dropbox\\Parameters\\Collections\\MemberSelectors::add",
            "doc": "&quot;Add one or more {@link MemberSelector}s to the collection&quot;"
        },
...

        {
            ...
            "fromName": "Alorel\\Dropbox\\Parameters",
            "fromLink": "Alorel/Dropbox/Parameters.html",
            "link": "Alorel/Dropbox/Parameters/MemberPolicy.html",
            "name": "Alorel\\Dropbox\\Parameters\\MemberPolicy",
            "doc": "&quot;Policy governing who can be a member of a shared folder. Only applicable to folders owned by a user on a team.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\MemberPolicy",
            "fromLink": "Alorel/Dropbox/Parameters/MemberPolicy.html",
            "link": "Alorel/Dropbox/Parameters/MemberPolicy.html#method_team",
            "name": "Alorel\\Dropbox\\Parameters\\MemberPolicy::team",
            "doc": "&quot;Only a teammate can become a member.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\MemberPolicy",
            "fromLink": "Alorel/Dropbox/Parameters/MemberPolicy.html",
            "link": "Alorel/Dropbox/Parameters/MemberPolicy.html#method_anyone",
            "name": "Alorel\\Dropbox\\Parameters\\MemberPolicy::anyone",
            "doc": "&quot;Anyone can become a member.&quot;"
        },

        {
            ...
            "fromName": "Alorel\\Dropbox\\Parameters",
            "fromLink": "Alorel/Dropbox/Parameters.html",
            "link": "Alorel/Dropbox/Parameters/MemberSelector.html",
            "name": "Alorel\\Dropbox\\Parameters\\MemberSelector",
            "doc": "&quot;Includes different ways to identify a member of a shared item. The value will be one of the following datatypes. New\nvalues may be introduced as the Dropbox API evolves.&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\MemberSelector",
            "fromLink": "Alorel/Dropbox/Parameters/MemberSelector.html",
            "link": "Alorel/Dropbox/Parameters/MemberSelector.html#method_dropboxID",
            "name": "Alorel\\Dropbox\\Parameters\\MemberSelector::dropboxID",
            "doc": "&quot;Constructs a member selector from a Dropbox ID&quot;"
        },
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Parameters\\MemberSelector",
            "fromLink": "Alorel/Dropbox/Parameters/MemberSelector.html",
            "link": "Alorel/Dropbox/Parameters/MemberSelector.html#method_email",
            "name": "Alorel\\Dropbox\\Parameters\\MemberSelector::email",
            "doc": "&quot;Constructs a member selector from their email&quot;"
        },
...

        {
            ...
            "fromName": "Alorel\\Dropbox\\Parameters",
            "fromLink": "Alorel/Dropbox/Parameters.html",
            "link": "Alorel/Dropbox/Parameters/SharedLinkPolicy.html",
            "name": "Alorel\\Dropbox\\Parameters\\SharedLinkPolicy",
            "doc": "&quot;Policy governing who can view shared links.&quot;"
        },
        ...
        {
            "type": "Method",
            "fromName": "Alorel\\Dropbox\\Util",
            "fromLink": "Alorel/Dropbox/Util.html",
            "link": "Alorel/Dropbox/Util.html#method_typeof",
            "name": "Alorel\\Dropbox\\Util::typeof",
            "doc": "&quot;Returns the type of the given item&quot;"
        },
